...
const ProjectCard = ({ index, name, description, tags, image, source_code_link }) => {
    return (
        <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
            <Tilt options={{ max: 45, scale: 1, speed: 450 }} className="bg-new-tertiary p-5 rounded-2xl sm:w-[360px] w-full">
                ...
                <div className="mt-5">
                    ...
                    <p className='mt-2 text-new-secondary text-[14px]'>{description}</p>
                </div>
